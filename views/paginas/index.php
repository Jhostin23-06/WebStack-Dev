...
<section class="speakers">
    ...
    <p class="speakers__descripcion">Conoce a nuestros expertos de WebStack</p>
...
<section class="boletos">
    ...
    <p class="boletos__descripcion">Precios para WebStack</p>

    <div class="boletos__grid">
        <div class="boleto boleto--presencial">
            <h4 class="boleto__logo">&#60;WebStack /></h4>
            <p class="boleto__plan">Presencial</p>
            <p class="boleto__precio">S/.349</p>
        </div>
        <div class="boleto boleto--virtual">
            <h4 class="boleto__logo">&#60;WebStack /></h4>
            <p class="boleto__plan">Virtual</p>
            <p class="boleto__precio">S/.199</p>
        </div>
